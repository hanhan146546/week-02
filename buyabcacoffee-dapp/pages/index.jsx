...
export default function Home() {
  ...
  const contractAddress = "0xAB1C2A01Af31667104c276A800d1cf088BEcF169";
            ...
            <div className={styles.frontcontent}>
                {currentAccount ? (
                    <form className={styles.form}>
                        ...
                        <div>
                            <button type="button" onClick={buyCoffee}>Send 1 Coffee for 0.01ETH</button>
                         <button
                          className={styles.buttonForm}
                          type="button"
                          onClick={() => buyCoffee("0.03")}
                        >
                         Super Large Coffee for 0.03ETH 
                        </button>
                       </div>
                    </form>
                ) : (
